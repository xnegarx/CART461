...
#line 1 "c:/Users/her/Downloads/STEMMA-CAPACITIVE-TOUCH-main/STEMMA-CAPACITIVE-TOUCH-main/src/STEMMA-CAPACITIVE-TOUCH_led.ino"
#include <Particle.h>
/* THESE ARE PARTICLE SPECIFIC PARAMETERS APPLIED AT CODE RUNTIME */
/* RUN ALL PARTICLE CLOUD COMMUNICATION IN SEPARATE THREAD */
void setup();
void loop();
#line 4 "c:/Users/her/Downloads/STEMMA-CAPACITIVE-TOUCH-main/STEMMA-CAPACITIVE-TOUCH-main/src/STEMMA-CAPACITIVE-TOUCH_led.ino"
...
void loop() {
  ...
  // // //Process animations for strip1 (touchpads 0 to 5)
  ...
  // //       if (ledPositions[i] > 0) {
  // //         for (int j = ledPositions[i] - 3; j < ledPositions[i]; j++) {
  // //           if (j >= 0) {
  ...
  // //       for (int j = ledPositions[i]; j < ledPositions[i] + 3 && j < NUMPIXELS; j++) {
  // //         if (j == ledPositions[i]) {
  ...
  // //       ledPositions[i] += 3; // Advance by 3 pixels
